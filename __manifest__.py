...
##############################################################################
{
    ...
    'name': 'List item serial number V15',
    ...
    'data': [ ],
    'assets': {
        'web.assets_qweb': ['list_item_number/static/src/**/*.xml'],
        'web.assets_backend': [
            'list_item_number/static/src/css/list_item_number.css',
            'list_item_number/static/src/js/list_item_number.js',
